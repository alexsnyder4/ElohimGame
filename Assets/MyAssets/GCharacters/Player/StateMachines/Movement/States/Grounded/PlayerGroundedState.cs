...
public class PlayerGroundedState : PlayerMovementState
{
    ...
    protected override void OnContactWithGroundExited(Collider collider)
    {
        ...
        Ray downwardsRayFromCapsuleBottom = new Ray(capsuleColliderCenterInWorldSpace - stateMachine.Player.ColliderUtility.CapsuleColliderData.ColiderVerticalExtents, Vector3.down);
